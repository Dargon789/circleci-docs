...
:experimental:
:page-aliases: scheduled-pipelines.adoc, scheduled-pipelines.html
...
Configure schedule triggers from menu:Project Settings[Project Setup] or menu:Project Settings[Triggers] in the web app, or via the API for GitHub OAuth or Bitbucket Cloud pipelines.
...
NOTE: Setting up schedule triggers via the API is not yet available for GitHub App pipelines.
